...
if __name__ == "__main__":
    RF.print_log("=== OPEX Scaling Detailed Test ===", "INFO")
    ...
    # Test with smaller equity to avoid hitting the cap
    equity = 10000.0  # Smaller equity to see scaling effect
    ...
    RF.print_log("OPEX scaling detailed test OK ✅", "SUCCESS")
