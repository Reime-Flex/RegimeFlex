...
if __name__ == "__main__":
    RF.print_log("=== OPEX Scaling Micro Equity Test ===", "INFO")
    ...
    # Test with micro equity to avoid hitting the cap
    equity = 1000.0  # Micro equity to see scaling effect
    ...
    RF.print_log("OPEX scaling micro equity test OK ✅", "SUCCESS")
